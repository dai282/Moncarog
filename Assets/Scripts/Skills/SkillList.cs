...
public class SkillList
{
    ...
    { 
        //basic moves
        skills[0] = new Skill("Rest", Normal, 0.0f, -50);
        skills[1] = new Skill("Bite", Normal, 10.0f, 10);
        skills[2] = new Skill("Tackle", Normal, 30.0f, 20);
        ...
        skills[9] = new Skill("Beatdown", Normal, 90.0f, 70);
